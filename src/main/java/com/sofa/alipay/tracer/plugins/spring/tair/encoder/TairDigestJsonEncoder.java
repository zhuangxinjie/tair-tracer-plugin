 ...
 */
package com.sofa.alipay.tracer.plugins.spring.tair.encoder;
...
/**
 * @ClassName: TairDigestJsonEncoder
 * @Description:
 * @Author: zhuangxinjie
 * @Date: 2021/6/17 6:32 下午
 */
public class TairDigestJsonEncoder extends AbstractDigestSpanEncoder {
    @Override
